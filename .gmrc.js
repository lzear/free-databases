console.log('🦺 antoinelog process.env.FLYIO_SHADOW_DATABASE_URL', process.env.FLYIO_SHADOW_DATABASE_URL);
...
module.exports = {
   ...
   */
  "connectionString": process.env.FLYIO_DATABASE_URL,
   ...
   */
  "shadowConnectionString": process.env.FLYIO_SHADOW_DATABASE_URL,
   ...
   */
  "rootConnectionString": process.env.FLYIO_ROOT_DATABASE_URL,
